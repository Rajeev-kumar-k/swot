              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    ...
                    <a href="index.html" class="d-flex align-items-center gap-2 dropdown-item">
            ...
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">SWOT</h5>
                  ...
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-1.jpg" alt="modernize-img" class="rounded-circle mb-3" width="80" height="80">
                      <a href="Staffdash"><h4 class="card-title mb-1"><b>Staff</b></h4></a>
                      <span class="fs-2">Medical Secretary</span>
                    </div>
                    <ul class="px-2 py-2 list-unstyled d-flex align-items-center justify-content-center mb-0">
                      <li class="position-relative">
                  ...
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-1.jpg" alt="modernize-img" class="rounded-circle mb-3" width="80" height="80">
                      <a href="userhome"><h4 class="card-title mb-1"><b>User</b></h4></a>
                      <span class="fs-2">Medical Secretary</span>
                    </div>
                    <ul class="px-2 py-2 list-unstyled d-flex align-items-center justify-content-center mb-0">
                      <li class="position-relative">
